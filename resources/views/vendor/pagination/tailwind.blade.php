        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5">
                    {!! __('Mostrando') !!}
                    <span class="font-medium font-extrabold">{{ $paginator->firstItem() }}</span>
                    {!! __('a') !!}
                    <span class="font-medium font-extrabold">{{ $paginator->lastItem() }}</span>
                    {!! __('de') !!}
                    <span class="font-medium font-extrabold">{{ $paginator->total() }}</span>
                    {!! __('registros') !!}
                </p>
            </div>
